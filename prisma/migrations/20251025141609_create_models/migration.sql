...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'RK Motors',
    "address" TEXT NOT NULL DEFAULT '1334, J.J.Complex, Shop No.1, Panjarpol Ind. Estate, Main Road, Kolhapur',
    "phone" TEXT NOT NULL DEFAULT '+918421000786',
    "email" TEXT NOT NULL DEFAULT 'yasinathanikar06@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
