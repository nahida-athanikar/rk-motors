...
export async function addCar({ carData, images }) {
  console.log("🔔 server action addCar called:", { carDataSummary: { make: carData?.make, model: carData?.model, year: carData?.year }, imagesCount: Array.isArray(images) ? images.length : 0 });
  try {
